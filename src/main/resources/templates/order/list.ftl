...
<#--主要内容content-->
    <div id="page-content-wrapper">
        ...
        <tr>
            ...
            <td>
                ${order.getOrderStatusEnums().message}
            </td>
            <td>${order.getPayStatusEnums().message} </td>
            <td>${order.createTime}</td>

            <td><a href="http://localhost:8080/sell/seller/order/detail?orderId=${order.orderId}">详情</a></td>
            <td>
                        <#if order.orderStatus == 0>
                            <a href="http://localhost:8080/sell/seller/order/cancel?orderId=${order.orderId}">取消</a>
                        </#if>
            </td>
        </tr>
        </#list>
